  ...
  return (
    <div className="min-h-screen bg-transparent flex items-center justify-center p-4">
      <div className="relative w-full max-w-sm flex flex-col items-center">
        ...
        <div className="w-11/12 h-16 bg-gray-900 rounded-full shadow-lg border border-gray-700 flex items-center px-6 relative z-20">
          ...
          <div className="ml-4 w-8 h-8 bg-yellow-500 rounded-full flex items-center justify-center text-black">
            <span className="text-xs font-bold">₿</span>
          </div>
        </div>

        {/* Card 2 - Middle (Shorter width, same height, visible overlap) */}
        <div className="-mt-6 w-10/12 h-16 bg-gray-900 rounded-full shadow-md border border-gray-700 flex items-center px-5 relative z-10">
          <div className="w-8 h-8 bg-green-500 rounded-full flex items-center justify-center text-white">
        ...
        <div className="-mt-6 w-9/12 h-16 bg-gray-900 rounded-full shadow-sm border border-gray-700 flex items-center px-4 relative z-0">
          ...
          <div className="ml-4 w-8 h-8 bg-purple-500 rounded-full flex items-center justify-center text-white">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" viewBox="0 0 20 20" fill="currentColor">
